...
(2, NULL, 'JSON', 'doaj', 'Directory of Open Access Journals (DOAJ)', 'https://doaj.org/', 'https://doaj.org/api/v1/search/articles/', '?pageSize=20&sort=last_updated%3Adesc', ' AND ', ' OR ', ' AND NOT ', '%28', '%29', '%22', 'bibjson.title', 'bibjson.author.name', 'bibjson.abstract', 'bibjson.publisher', 'bibjson.subject.term', 'bibjson.abstract', 1),
...
(4, NULL, 'RSS', 'plos', 'PLOS', 'http://journals.plos.org', 'http://journals.plos.org/plosone/search/feed/atom?resultsPerPage=30&q=', '&sortOrder=DATE_NEWEST_FIRST&page=1', '+AND+', '+OR+', '+NOT+', '%28', '%29', NULL, 'title%3A', 'author%3A', 'abstract%3A', 'everything%3A', 'subject%3A', 'everything%3A', 1);

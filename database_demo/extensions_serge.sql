...
CREATE TABLE `extensions_serge` (
	...
	`label_content_EN` text COLLATE utf8mb4_bin NOT NULL,
	`label_content_FR` text COLLATE utf8mb4_bin,
	`label_content_ES` text COLLATE utf8mb4_bin,
	`label_content_DE` text COLLATE utf8mb4_bin,
	`label_content_CN` text COLLATE utf8mb4_bin,

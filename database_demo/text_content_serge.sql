...
('functionality8_text_index', 'You will be able to do your news watch and branding watch on Twitter. Serge will look for any tweet that match your criterias. You will be alerted about a very recent news or to understand how your brand is perceived', 'Vous pourrez faire votre veille d\'actualité et d\'image de marque sur Twitter. Serge cherchera tout les tweet qui correspondent à vos critères. Vous pourrez ainsi être alerté d\'une actualité très récente ou comprendre comment votre marque est perçu', NULL, NULL, NULL),
('functionality9_text_index', 'A wiki will be set up, to classify, annotate and share the news, with your colleagues or in a totally public way', 'Un wiki va être mis en place, afin de classer, annoter et partager les actualités, avec vos collègues ou de manière totalement public', NULL, NULL, NULL),
('functionality10_text_index', 'A feature of Serge allows you to receive news as soon as it is found, in the future you will be alerted of a precise news directly by SMS', 'Une fonctionnalité de Serge vous permet de recevoir des actualité dès qu\'elle sont trouvé, à l\'avenir, vous pourrez être alerté d\'une actualité précise directement par SMS', NULL, NULL, NULL),
('functionality11_text_index', 'In order to improve your search criteria, statistics about your news watch will be available on the option page', 'Afin d\'améliorer vos critères de recherche des statistique seront bientôt disponible sur la page Option', NULL, NULL, NULL),
...
('input3_signup_index', 'Passphrase again', 'phrase passe à nouveaux', NULL, NULL, NULL),

...
('functionality11_text_index', 'In order to improve your search criteria, statistics about your news watch will be available on the option page', 'Afin d\'améliorer vos critères de recherches, des statistiques seront bientôt disponibles sur la page paramétrage', NULL, NULL, NULL),
...
('tab3_title_nav', 'Configuration', 'Paramétrage', NULL, NULL, NULL),
...
('main_title_setting', 'Configuration', 'Paramétrage', NULL, NULL, NULL),
...
('selectTitle_window1_setting', 'Change your background', 'Changer votre arrière-plan', NULL, NULL, NULL),
...
('title0_changePass_connection', 'Change passphrase', 'Changer la phrase de passe', NULL, NULL, NULL),
('submit0_changePass_connection', 'Submit', 'Envoyer', NULL, NULL, NULL),
('title1_changePass_connection', 'Reset passphrase', 'Changer la phrase de passe', NULL, NULL, NULL),
('checkMail_changePass_connection', 'Your request has been successfully sent, please check your emails to reset your passphrase', 'Votre demande a été envoyée avec succès, veuillez vérifier vos emails, afin de réinitialiser votre phrase de passe', NULL, NULL, NULL),
('invalidRequest_changePass_connection', 'Your request is invalid or too old', 'Votre demande est invalide ou trop ancienne', NULL, NULL, NULL),
...
('intro_date', 'your news monitoring of', 'votre veille du', NULL, NULL, NULL),
('intro_links', 'links in', 'liens dans', NULL, NULL, NULL),
('type_news', 'News', 'Actualités', NULL, NULL, NULL),
('type_sciences', 'Scientific Publications', 'Publications Scientifiques', NULL, NULL, NULL),
('type_patents', 'Patents', 'Brevets', NULL, NULL, NULL),
('web_serge', 'View Online', 'Voir sur le web', NULL, NULL, NULL),
('unsubscribe', 'Unsubscribe', 'Se&nbsp;désinscrire', NULL, NULL, NULL),
...
('Watchpacks management', 'Watchpacks management', 'Gestion des packs de veille', NULL, NULL, NULL),
('Hello', 'Hello', 'Bonjour', NULL, NULL, NULL),
('WatchPack', 'WatchPack', 'Pack&nbsp;veille', NULL, NULL, NULL),
('News', 'News', 'Actualités', NULL, NULL, NULL),
('Science', 'Science', 'Science', NULL, NULL, NULL),
('Patent', 'Patent', 'Brevet', NULL, NULL, NULL),
('Premium presentation', 'Premium presentation', 'Présentation du Premium', NULL, NULL, NULL),
('Remaining number of SMS', 'Remaining number of SMS', 'Nombre restant de SMS', NULL, NULL, NULL),
('Your SMS payment history', 'Your SMS payment history', 'Votre historique de paiement de SMS', NULL, NULL, NULL),
('Change your passphrase', 'Change your passphrase', 'Changer votre phrase de passe', NULL, NULL, NULL),
('Change your language', 'Change your language', 'Changer votre langue', NULL, NULL, NULL),
('Delete my account', 'Delete my account', 'Supprimer mon compte', NULL, NULL, NULL),
('Are you sure you want to delete your account ?', 'Are you sure you want to delete your account ?', 'Êtes-vous sûr de vouloir supprimer votre compte ?', NULL, NULL, NULL),
('Add SMS in your account', 'Add SMS in your account', 'Ajouter des SMS sur votre compte', NULL, NULL, NULL),
('Mail configuration', 'Mail configuration', 'Paramétrage email', NULL, NULL, NULL),
('SMS configuration', 'SMS configuration', 'Paramétrage SMS', NULL, NULL, NULL),
('Privacy configuration', 'Privacy configuration', 'Paramétrage vie privée', NULL, NULL, NULL),
('Source link', 'Source link', 'Lien de la source', NULL, NULL, NULL),
('Any web page, Serge is in charge of finding RSS feeds and diary', 'Any web page, Serge is in charge of finding RSS feeds and diary', 'Toute page web, Serge se charge de trouver les flux RSS et agenda', NULL, NULL, NULL),
('Special keywords -- :all to retrieve all links; :alert to receive the result directly overriding the sending conditions', 'Special keywords -- :all to retrieve all links; :alert to receive the result directly overriding the sending conditions', 'Mots-clefs spéciaux -- :all pour récupérer tout les liens; :alert pour recevoir directement le résultat en outrepassant les conditions d\'envoi', NULL, NULL, NULL),
('Premium functionality', 'Premium functionality', 'Fonctionnalité Premium', NULL, NULL, NULL),
('Receive your results by email', 'Receive your results by email', 'Recevez vos résultats par email', NULL, NULL, NULL),
('Communication of results', 'Communication of results', 'Communication des résultats', NULL, NULL, NULL),
('Delete history', 'Delete history', 'Supprimer l\'historique', NULL, NULL, NULL),
('Read monitoring', 'Read monitoring', 'Suivi de lecture', NULL, NULL, NULL),
('Receive your alerts by SMS', 'Receive your alerts by SMS', 'Recevez vos alertes par SMS', NULL, NULL, NULL),
('Update phone number', 'Update phone number', 'Mise à jour du numéro de téléphone', NULL, NULL, NULL),
('Your phone number', 'Your phone number', 'Votre numéro de téléphone', NULL, NULL, NULL),
('Premium feature - SMS', 'Premium feature - SMS', 'Fonctionnalité Premium - SMS', NULL, NULL, NULL),
('Premium feature - Email', 'Premium feature - Email', 'Fonctionnalité Premium - Email', NULL, NULL, NULL),
...
('Fujiyama','Fujiyama','Fujiyama', NULL, NULL, NULL),
('Forest mountain','Mountain forest','Forêt de montagne', NULL, NULL, NULL),
('Mountain lake', 'Mountain lake', 'Lac de montagne', NULL, NULL, NULL),
('Natural valley', 'Natural valley', 'Vallée naturelle', NULL, NULL, NULL),
('Lake', 'Lake', 'Lac', NULL, NULL, NULL),
('Waterfall cairn', 'Cairn & waterfall', 'Cairn & chute d\'eau ', NULL, NULL, NULL),
('Cloudy nature', 'Cloudy nature', 'Nature nuageuse', NULL, NULL, NULL),
('Forest', 'Forest', 'Forêt', NULL, NULL, NULL),
('On a lake', 'On a lake', 'Sur un lac', NULL, NULL, NULL),
('Blue Sea', 'Blue sea', 'Mer blue', NULL, NULL, NULL),
('Sea cairn', 'Cairn & sea', 'Cairn & mer', NULL, NULL, NULL),
('Sea', 'Sea', 'Mer', NULL, NULL, NULL),
('Peaceful sea', 'Peaceful sea', 'Mer paisible', NULL, NULL, NULL),
('Skyscrapers', 'Skyscrapers', 'Gratte-ciel', NULL, NULL, NULL),

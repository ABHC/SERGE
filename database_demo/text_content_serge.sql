...
('functionality10_text_index', 'A feature of Serge allows you to receive news as soon as it is found, in the future you will be alerted of a precise news directly by SMS', 'Une fonctionnalité de Serge vous permet de recevoir les actualités dès qu\'elles sont trouvées. Vous pourrez ainsi être alerté au sujet d\'une actualité précise, directement par SMS', NULL, NULL, NULL),
...
('title2_premium_setting', 'Your email need to be verify', 'Votre email doit être vérifié', NULL, NULL, NULL),

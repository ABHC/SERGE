...
<div class="body">
	...
	<div class="purchase">
		...
		<form method="post" action="purchase">
			...
			<p class="title_form_purchase"><?php get_t('input1_purchase_purchase', $bdd); ?></p> <p><input class="number alpha" type="number" name="months" min="1" value="1"/><?php get_t('input1_text_purchase', $bdd); ?></p>
			...
			<p><input type="checkbox" name="readCGS" id="CGS" /><label class="checkbox" for="CGS"></label><a href="legal" ><?php get_t('input3_purchase_purchase', $bdd); ?></a></p>

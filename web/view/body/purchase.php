...
<div class="body">
	...
	<div class="purchase">
		...
		<form method="post" action="purchase">
			...
			<p class="title_form_purchase"><?php get_t('input1_purchase_purchase', $bdd); ?></p> <p><input class="number alpha" type="number" name="months" min="1" value="1" onchange="updatePrice(this.value);"/><?php get_t('input1_text_purchase', $bdd); ?></p>

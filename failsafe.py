...
def checkMate():
	...
	if num_tables < 18:
		...
		if num_tables == (21+optionnal_tables):
			logger_info.info("Number of tables : check")
		elif num_tables < (21+optionnal_tables):
	...
	expected_tables_list = ["admin_table_serge", "background_serge", "keyword_news_serge", "language_serge", "patents_sources_serge", "premium_code_table_serge", "purchase_table_serge", "queries_science_serge", "queries_wipo_serge", "result_news_serge", "result_patents_serge", "result_science_serge", "rss_serge", "science_sources_serge", "text_content_serge", "miscellaneous_serge", "newsletter_table_serge", "users_table_serge", "watch_pack_queries_serge", "watch_pack_serge", "captcha_serge"]
	...
	premium_code_table_serge_numbers = 5
	purchase_table_serge_numbers = 7
	...
	premium_code_table_serge_columns = ["id", "code", "creation_date", "users", "duration_premium"]
	purchase_table_serge_columns = ["id", "user_id", "purchase_date", "duration_premium", "invoice_number", "price", "bank_details"]
	...
	users_table_serge_columns = ["id", "users", "email", "password", "salt", "signup_date", "last_mail", "send_condition", "frequency", "link_limit", "selected_days", "selected_hour", "mail_design", "language", "record_read", "history_lifetime", "background_result", "premium", "token"]

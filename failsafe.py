...
def checkMate(database, logger_info, logger_error):
    ...
    users_table_serge_columns = ["id", "users", "email", "password", "last_mail", "send_condition", "frequency", "link_limit", "selected_days", "selected_hour", "mail_design", "language", "record_read", "background_result", "permission_news", "permission_science", "permission_patents"]

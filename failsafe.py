...
def checkMate():
	...
	admin_table_serge_columns = [
	"id",
	"admin",
	"email"]

	background_serge_columns = [
	"id",
	"name",
	"filename",
	"type"]
	...
	inquiries_news_serge_columns = [
	"id",
	"inquiry",
	"applicable_owners_sources",
	"active"]

	inquiries_patents_serge_columns = [
	"id",
	"inquiry",
	"legal_research",
	"applicable_owners_sources",
	...
	inquiries_sciences_serge_columns = [
	"id",
	"inquiry",
	"applicable_owners_sources",
	"active"]

	language_serge_columns = [
	"code",
	"name"]

	miscellaneous_serge_columns = [
	"name",
	"value"]

	newsletter_table_serge_columns = [
	"id",
	"email",
	"signup_date"]

	premium_code_table_serge_columns = [
	"id",
	"code",
	"creation_date",
	"users",
	...
	price_table_serge_columns = [
	"id",
	"price",
	"currency",
	"type"]

	purchase_table_serge_columns = [
	"id",
	"user_id",
	"purchase_date",
	"duration_premium",
	...
	credentials_sms_serge_columns = [
	"endpoint",
	"application_key",
	"application_secret",
	"consumer_key"]

	results_news_serge_columns = [
	"id",
	"search_index",
	"title",
	"link",
	...
	results_sciences_serge_columns = [
	"id",
	"search_index",
	"title",
	"link",
	...
	sources_sciences_serge_columns = [
	"id",
	"apikey",
	"type",
	"basename",
	...
	stripe_table_serge_columns = [
	"id",
	"account_name",
	"secret_key",
	"publishable_key"]

	text_content_serge_columns = [
	"index_name",
	"EN",
	"FR",
	"ES",
	...
	watch_pack_queries_serge_columns = [
	"id",
	"pack_id",
	"query",
	"source"]

	watch_pack_serge_columns = [
	"id",
	"search_index",
	"name",
	"description",

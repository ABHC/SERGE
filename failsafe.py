...
def checkMate():
	...
	users_table_serge_columns = ["id", "users", "email", "phone_number", "password", "salt", "signup_date", "result_by_email", "last_mail", "send_condition", "frequency", "link_limit", "selected_days", "selected_hour", "mail_design", "language", "record_read", "history_lifetime", "background_result", "alert_by_sms", "premium_expiration_date", "email_validation", "sms_credits", "token", "add_source_status"]
